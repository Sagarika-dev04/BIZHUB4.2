...
const Card: React.FC<CardProps> = ({ business }) => {
  ...
  return (
    <div className="bg-slate-50 rounded-md shadow border border-cyan-100 overflow-hidden w-full max-w-xl flex flex-col md:flex-row hover:scale-[1.01] hover:shadow-lg transition-all duration-300">
      {/* Image */}
      ...
      <div className="flex flex-col justify-between p-4 flex-1 h-full overflow-hidden">
        ...
        <button
          ...
          className="mt-3 bg-blue-950 text-white px-3 py-1 text-sm rounded-md  hover:cursor-pointer hover:text-gray-300 transition w-fit"
        >
          View Details
        </button>
      </div>
