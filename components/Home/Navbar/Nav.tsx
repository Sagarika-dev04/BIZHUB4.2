    ...
    <div className="bg-blue-950 shadow-md transition-all duration-200 h-[11vh] z-[1000] fixed w-full">
      <div className="flex items-center h-full justify-between w-[90%] xl:w-[80%] mx-auto">
        ...
        <div className="flex items-center space-x-2 sm:space-x-4 relative">
          {!session && (
            <>
              <button onClick={() => router.push("/login")} className="flex items-center justify-center space-x-2 px-3 sm:px-5 md:px-7 lg:px-8 py-2 text-blue-900 bg-white rounded-lg hover:cursor-pointer  hover:bg-gray-100">
              ...
              <button onClick={() => router.push("/signup")} className="flex items-center justify-center space-x-2 px-3 sm:px-5 md:px-7 lg:px-8 py-2 text-white bg-cyan-500 rounded-lg hover:cursor-pointer  hover:bg-cyan-600">
          ...
          {session && user?.userType === "Business Owner" && (
            <button onClick={() => router.push("/addCard")} className="flex items-center justify-center space-x-2 px-3 sm:px-5 md:px-7 py-2 text-white bg-green-600 rounded-lg hover:cursor-pointer  hover:bg-green-700">
          ...
          {session && (
            <div className="relative" ref={userMenuRef}>
              ...
              <div className={`absolute right-0 mt-3 w-64 bg-white rounded-xl shadow-lg z-50 px-4 py-3 transition-all duration-300 ${
